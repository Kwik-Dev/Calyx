...
// Hermes, Grok, pi, and Crush, collecting results independently so one
...
struct IPCConfigManager: Sendable {
    ...
    /// Enables IPC MCP server config in Claude Code, Codex, OpenCode, Hermes, Grok, pi, and Crush config files.
    ...
    /// Disables IPC MCP server config in Claude Code, Codex, OpenCode, Hermes, Grok, pi, and Crush config files.
    ...
    static func isIPCEnabled() -> (claudeCode: Bool, codex: Bool, openCode: Bool, hermes: Bool, grok: Bool, pi: Bool, crush: Bool) {
        (
